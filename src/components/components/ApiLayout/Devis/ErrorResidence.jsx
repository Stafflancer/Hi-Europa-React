  ...
  return (
    <Container>
      <div className="api-content error-notice">
        ...
        <Row>
          <Col>
            <h1>{t("devis.errorResidence.Title")}</h1>
          </Col>
        </Row>
        <Row>
          <Col>
            <p>
              {t("devis.errorResidence.Text")}
            </p>
          </Col>
        </Row>
        <Row>
          <Col>
            <h2>{t("devis.errorResidence.SubTitle")}</h2>
          </Col>
        </Row>
        <Row>
          <Col md={{ span: 6, offset: 3 }} lg={{ span: 4, offset: 4 }}>
            <Form.Label className="api-label">{t("devis.errorResidence.Email")}</Form.Label>
        ...
        <Row>
          <Col md={{ span: 6, offset: 3 }}>
            <div className="m-checkbox">
              ...
              />
              <label className="m-checkbox__label" >{t("devis.errorResidence.Check")}</label>
            </div>
          </Col>
        </Row>
        <Row>
          <Col md={{ span: 6, offset: 3 }} lg={{ span: 4, offset: 4 }}>
            <Button className="api-button" bsPrefix="api" variant="large" onClick={handleClick}>{t("devis.errorResidence.Button")}</Button>
          </Col>
        </Row>
      </div>
      <div className="api-footer error-notice">
        <Row>
          <Col>
            <a href="#">
              <span>{t("devis.errorResidence.Return")}</span>
            </a>
          </Col>
        </Row>
        <Row>
          <Col>
            <a className="api-back red" href="#" onClick={() => { props.goToStep(4) }}>
