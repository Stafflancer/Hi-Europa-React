    ...
    <Container>
      <div className="api-content error-notice">
        ...
        <Row>
          <Col>
            <p>
              Pour des raisons légales, il nous est impossible de vous proposer de changer d'assurance dès aujourd'hui. Si vous le souhaitez, on pourra vous prévenir dès qu'il sera légalement possible pour vous de changer d'assurance.
            </p>
          </Col>
        </Row>
        <Row>
          <Col>
            <h2>Laissez-nous votre e-mail et soyez le premier à être informé.</h2>
          </Col>
        </Row>
        <Row>
