...
const FAQHabitationPage = (props) => {
  const { t } = useTranslation();
  const sectionsLeft =
    content.translations["Assurance Habitation FAQ"]["left"]["section"];
  const sectionsRight =
    content.translations["Assurance Habitation FAQ"]["right"]["section"];
  return (
    <div className="FAQ-page">
      <_Helmet pageName="FAQ - home insurance"></_Helmet>
      ...
      <div className="FAQ-wrap bg-white">
        <h4 className="title">{t("FAQ Page.category 2")}</h4>
              ...
              {sectionsLeft.map((item, index) => (
                <div key={index}>
                  <h5 className="topic-name">
                    {t(`Assurance Habitation FAQ.left.section.${index}.title`)}
                  </h5>
                  <ul className="questions-list">
                    {Object.values(item.QA).map((i, _index) => (
                      <li className="question" key={_index}>
                        ...
                        >
                          {t(
                            `Assurance Habitation FAQ.left.section.${index}.QA.QA${
                              _index + 1
                            }.Q`
                          )}
                        </a>
          ...
          <div className="right-column">
            <div className="topic-wrap">
              {sectionsRight.map((item, index) => (
                <div key={index}>
                  <h5 className="topic-name">
                    {t(`Assurance Habitation FAQ.right.section.${index}.title`)}
                  </h5>
                  <ul className="questions-list">
                    {Object.values(item.QA).map((i, _index) => (
                      <li className="question" key={_index}>
                        ...
                        >
                          {t(
                            `Assurance Habitation FAQ.right.section.${index}.QA.QA${
                              _index + 1
                            }.Q`
                          )}
                        </a>
...
export default FAQHabitationPage;
